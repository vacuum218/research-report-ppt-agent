...
def test_optional_document_bundle_references_are_backward_compatible(validator, valid_outline):
    instance = copy.deepcopy(valid_outline)
    instance["slides"][1]["section_ref"] = "sec-1-2"
    instance["slides"][1]["evidence_refs"] = [
